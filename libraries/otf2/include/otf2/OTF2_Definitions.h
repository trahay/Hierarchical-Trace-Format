...
enum OTF2_RegionFlag_enum {
  ...
  /** @brief Each time this region is entered it will at an individual call path
   *  in the profile.
   */
  OTF2_REGION_FLAG_DYNAMIC = (1 << 0),

  /** @brief Each time this region is entered it will at an individual root node
   *  in the profile.
   */
...
enum OTF2_MetricValueProperty_enum {
  ...
  /** @brief This mask can be used to at lower half-byte in @eref{OTF2_MetricMode}
...
enum OTF2_MetricTiming_enum {
  ...
  /** @brief This mask can be used to at the upper half-byte in
