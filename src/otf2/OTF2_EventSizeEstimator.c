...
#include "OTF2_EventSizeEstimator.h"
#include "htf.h"
#include "otf2.h"
 ...
 *  @return @eref{OTF2_SUCCESS} if successful, an error code if an error occurs.
 */
OTF2_ErrorCode OTF2_EventSizeEstimator_SetNumberOfCallingContextDefinitions(
  OTF2_EventSizeEstimator* estimator,
 ...
 *
 * Definition ids are considered to be in the range
 * [0, numberOfLocationGroupDefinitions).
 *
 *  @param estimator   Estimator object.
 *  @param numberOfLocationGroupDefinitions The number of definitions.
 *
 *  @since Version 1.0
 *
 *  @return @eref{OTF2_SUCCESS} if successful, an error code if an error occurs.
